#include "_c_algClass_0348.h"
#include "../base/baseTool.h"

bool _c_algClass_0348::seekMemberListPointer() {
    mainPhotoType = e0348;
...
bool _c_algClass_0348::ResultEdit() {
...
std::string _c_algClass_0348::getPhotoName(std::string algcode) {
