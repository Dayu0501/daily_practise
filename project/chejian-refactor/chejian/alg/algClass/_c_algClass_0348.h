#ifndef _C_ALGCLASS_0348_H
#define _C_ALGCLASS_0348_H
#include "_c_algBaseClass.h"

class _c_algClass_0348 : public _c_algBaseClass {
public:
	...
	std::vector <memberItem> resultMemberList = {
		...
		{"gunTong", "滚筒(平板)", &gunTong2, false, CONFIG_NOCHECK},
	...
	std::vector <memberItem> resultMemberList_video = {
		{"chePaiHao", "车牌号不正确", &chePaiHao, true, CONFIG_DEFAULT},
		{"erZhou", "车轮位置不对", &erZhou, true, CONFIG_DEFAULT},
