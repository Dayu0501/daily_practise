#ifndef _C_ALGTASKCENTER_LIANGJIANG_H
#define _C_ALGTASKCENTER_LIANGJIANG_H
...
class  _c_algTaskCenter_LiangJiang:public _c_algTaskCenter
{
public:
    _c_algTaskCenter_LiangJiang(CityType cityType,PREDIS_PARAM redisParam);
