#ifndef _C_ALGTASKCENTER_LANZHOU_H
#define _C_ALGTASKCENTER_LANZHOU_H
...
class  _c_algTaskCenter_LanZhou:public _c_algTaskCenter
{
public:
    _c_algTaskCenter_LanZhou(CityType cityType,PREDIS_PARAM redisParam);
