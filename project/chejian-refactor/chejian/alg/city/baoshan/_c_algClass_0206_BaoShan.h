#ifndef _C_ALGCLASS_0206_BAOSHAN_H
#define _C_ALGCLASS_0206_BAOSHAN_H
#include "alg/algClass/_c_algBaseClass.h"

class _c_algClass_0206_BaoShan:public _c_algBaseClass{
public:
    ...
    std::vector<memberItem> resultMemberList_baodan = {
        ...
        {"zhengBenHuoFuBen", "不是合格的保单<正/副本/抄件>文件", &zhengBenHuoFuBen, true, CONFIG_NOCHECK_UNABLE},
        ...
        {"zhiZhiBaoDan", "不是纸质保单", &zhiZhiBaoDan,  false, CONFIG_NOCHECK},
        {"chaoBen", "抄件不通过", &chaoBen, false, CONFIG_NOCHECK},
        {"tableID", "表单种类id", &tableID, false, CONFIG_NOCHECK},
    };
    ...
    virtual ~_c_algClass_0206_BaoShan(){}
    virtual bool seekMemberListPointer();
    virtual bool InParamEdit();
    virtual bool ResultEdit();
};

#endif // _C_ALGCLASS_0206_BAOSHAN_H
