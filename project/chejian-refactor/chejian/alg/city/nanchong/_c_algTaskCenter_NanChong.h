#ifndef _C_ALGTASKCENTER_NANCHONG_H
#define _C_ALGTASKCENTER_NANCHONG_H
...
class  _c_algTaskCenter_NanChong : public _c_algTaskCenter
{
public:
    _c_algTaskCenter_NanChong(CityType cityType, PREDIS_PARAM redisParam);
