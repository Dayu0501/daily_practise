#ifndef _C_ALGTASKCENTER_NANCHANG_H
#define _C_ALGTASKCENTER_NANCHANG_H
...
class  _c_algTaskCenter_NanChang:public _c_algTaskCenter
{
public:
    _c_algTaskCenter_NanChang(CityType cityType,PREDIS_PARAM redisParam);
