#ifndef _C_ALGTASKCENTER_QIANGDONGNAN_H
#define _C_ALGTASKCENTER_QIANGDONGNAN_H
...
class  _c_algTaskCenter_QianDongNan:public _c_algTaskCenter
{
public:
    _c_algTaskCenter_QianDongNan(CityType cityType,PREDIS_PARAM redisParam);
