#ifndef _C_ALGTASKCENTER_EERDUOSI_H
#define _C_ALGTASKCENTER_EERDUOSI_H
...
class  _c_algTaskCenter_EErDuoSi : public _c_algTaskCenter
{
public:
    _c_algTaskCenter_EErDuoSi(CityType cityType,PREDIS_PARAM redisParam);
