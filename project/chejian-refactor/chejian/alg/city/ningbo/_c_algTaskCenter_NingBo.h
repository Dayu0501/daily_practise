#ifndef _C_ALGTASKCENTER_NINGBO_H
#define _C_ALGTASKCENTER_NINGBO_H
...
class  _c_algTaskCenter_NingBo:public _c_algTaskCenter
{
public:
    _c_algTaskCenter_NingBo(CityType cityType,PREDIS_PARAM redisParam);
