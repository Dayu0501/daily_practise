#ifndef _C_ALGTASKCENTER_XUANCHENG_H
#define _C_ALGTASKCENTER_XUANCHENG_H
...
class  _c_algTaskCenter_XuanCheng:public _c_algTaskCenter
{
public:
    _c_algTaskCenter_XuanCheng(CityType cityType,PREDIS_PARAM redisParam);
