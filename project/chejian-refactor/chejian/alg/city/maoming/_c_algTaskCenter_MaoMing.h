#ifndef _C_ALGTASKCENTER_MAOMING_H
#define _C_ALGTASKCENTER_MAOMING_H
...
class  _c_algTaskCenter_MaoMing:public _c_algTaskCenter
{
public:
    _c_algTaskCenter_MaoMing(CityType cityType,PREDIS_PARAM redisParam);
