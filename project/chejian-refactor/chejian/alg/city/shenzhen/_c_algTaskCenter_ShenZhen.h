#ifndef _C_ALGTASKCENTER_SHENZHEN_H
#define _C_ALGTASKCENTER_SHENZHEN_H
...
class  _c_algTaskCenter_ShenZhen:public _c_algTaskCenter
{
public:
    _c_algTaskCenter_ShenZhen(CityType cityType,PREDIS_PARAM redisParam);
