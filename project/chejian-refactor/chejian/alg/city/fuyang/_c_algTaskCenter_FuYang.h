#ifndef _C_ALGTASKCENTER_FUYANG_H
#define _C_ALGTASKCENTER_FUYANG_H
...
class  _c_algTaskCenter_FuYang:public _c_algTaskCenter
{
public:
    _c_algTaskCenter_FuYang(CityType cityType,PREDIS_PARAM redisParam);
