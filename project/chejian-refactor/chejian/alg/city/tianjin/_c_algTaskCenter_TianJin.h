#ifndef _C_ALGTASKCENTER_TIANJIN_H
#define _C_ALGTASKCENTER_TIANJIN_H
...
class  _c_algTaskCenter_TianJin:public _c_algTaskCenter
{
public:
    _c_algTaskCenter_TianJin(CityType cityType,PREDIS_PARAM redisParam);
