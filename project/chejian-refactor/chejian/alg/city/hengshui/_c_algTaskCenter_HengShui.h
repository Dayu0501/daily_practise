#ifndef _C_ALGTASKCENTER_HENGSHUI_H
#define _C_ALGTASKCENTER_HENGSHUI_H
...
class  _c_algTaskCenter_HengShui:public _c_algTaskCenter
{
public:
    _c_algTaskCenter_HengShui(CityType cityType,PREDIS_PARAM redisParam);
