#ifndef _C_ALGTASKCENTER_SUZHOU_H
#define _C_ALGTASKCENTER_SUZHOU_H
...
class  _c_algTaskCenter_SuZhou:public _c_algTaskCenter
{
public:
    _c_algTaskCenter_SuZhou(CityType cityType,PREDIS_PARAM redisParam);
