...
enum LogPriority
{
        ...
        */
		...
		LP_STANDARD  =   LP_BASE << 15,

        // \}

};

std::string FormatLog(const std::string & sFormat, LogPriority iLogPriority, const char * szFile, int iLine, const char * szFunction,int max_length, const char * szFmt, ...);
