...
#define AC_LOG(LP, ...) \
        ::yt::LogDispatcher::Instance()->Log(LP, ::yt::FormatLog(::yt::LogDispatcher::Instance()->GetLogger(LP)->GetFormat(), LP, __FILE__, __LINE__, __FUNCTION__,MAX_LENGTH, __VA_ARGS__))
